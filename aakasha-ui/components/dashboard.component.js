          ...
          <div className="card-box">
            ...
            <div className="row align-items-center">
              <div className="col-6 col-md-6 text-center">
                <Image src="/images/pie-chart.PNG" alt="" width={150} height={150} />
              </div>
              <div className="col-6 col-md-6 text-center">
          ...
          <div className="card-box">
            ...
            <div className="customer-item">
              <div className="customer-name">
                <Image src="/images/user2.png" alt="" width={30}   height={30}/> Venkatesh Prasad
              </div>
              <div className="badge badge-primary">500 MB</div>
            </div>
            <div className="customer-item">
              <div className="customer-name">
                <Image src="/images/user1.png" alt="" width={30}  height={30} /> Srinath Kumar
              </div>
